'''
File:       Hybrid_GCH_SA_withoutCapacity.py
...
Summary of File:
    ...
    Classrooms have equal capacity (number of seats).
'''
...
def initial_population(availability, classrooms_list, classroom_cap, conflict_lists_index, number_of_lectures, number_of_student):
    ...
    shuffle_room_list = copy.copy(random.shuffle(classrooms_list))
    counter = 0
    time1 = time.time()
    while(True):
